...
from .views import (
    ...
    DemandMatrixImportApplyView, DemandMatrixImportTemplateView,
)
...
urlpatterns = [
    ...
    path("demand-matrix/import/template/", DemandMatrixImportTemplateView.as_view(), name="demand_matrix_import_template"),
